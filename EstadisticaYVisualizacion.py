...
sns.scatterplot(data=fumadores, x="age", y="charges")

# %%
#sns.scatterplot(data=no_fumadores, x="age", y="charges")
df.head()


# %%
pd.cut(fumadores.bmi, [12,18.5,25,30,60], labels=['De bajo peso', 'Normal', 'Sobrepeso', 'Obesidad'])


# %%
fumadores['bmi_cat'] = pd.cut(df.bmi, [12,18.5,25,30,60], labels=['De bajo peso', 'Normal', 'Sobrepeso', 'Obesidad'])
fumadores.head()


# %%
sns.violinplot(data=fumadores, x="bmi_cat", y="charges", hue="sex",split=True )
